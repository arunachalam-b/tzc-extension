function showTimezonePopup(selectedText) {
  ...
  const createTimezoneBox = (location, abbreviation, localTime, isUserTimezone = false) => {
    ...
    timezoneBox.style.background = isUserTimezone ? "#e9f7ef" : "#f9f9f9";
    ...
    locationElement.style.maxWidth = "200px";
    ...
    dateTime24Element.textContent = `${localTime.toISOString().slice(0, 19).replace("T", " ")}`;
